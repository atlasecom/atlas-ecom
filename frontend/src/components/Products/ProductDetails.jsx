        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="p-4 sm:p-6 lg:p-8 800px:pl-10">
              ...
              {/* Price Section */}
              <div className="mb-6 sm:mb-8 bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl p-4 sm:p-6 border border-gray-100">
                {data.discountPrice ? (
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                    ...
                    <div className="flex items-center gap-2 bg-green-100 rounded-lg px-2 sm:px-3 py-1">
                      ...
                      <span className="text-sm sm:text-lg font-semibold text-green-600">
                        {t("common.youSave", "You Save")} {formatCurrency(data.originalPrice - data.discountPrice)}
                      </span>
                    </div>
                  </div>
                ) : (
                ...
                <div className="mt-3 sm:mt-4 flex items-center gap-2 bg-orange-50 rounded-lg px-3 sm:px-4 py-2 border border-orange-200">
                  ...
                  <span className="text-xs sm:text-sm font-medium text-orange-700">
                    {t("common.minimumQuantity", "Minimum quantity to order")}: <span className="font-bold">{data.minQuantity || 1}</span>
                  </span>
                </div>
              </div>
