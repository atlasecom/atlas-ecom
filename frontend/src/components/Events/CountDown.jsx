    ...
    return (
      <div key={interval} className="flex flex-col items-center min-w-0">
        <div className="relative">
          {/* Time Value */}
          <div className="bg-orange-500 text-white font-semibold text-xs sm:text-sm px-1.5 sm:px-2 py-1 rounded-md min-w-[36px] sm:min-w-[40px] text-center leading-none">
            {timeLeft[interval]}
          </div>
        </div>
        
        {/* Time Label */}
        <span className="text-orange-600 text-xs mt-1 capitalize text-center leading-tight truncate w-full">
